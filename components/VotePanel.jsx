...
export default function VotePanel({ players, onVote }) {
  ...
  return (
    <div className="flex flex-col gap-12 mt-12 mb-12 items-center w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full mb-8">
        {players.map((p, i) => (
          <button
            ...
            className={`p-8 rounded-xl font-bold text-xl transition-all w-full flex flex-col items-center justify-center mb-2
              ${selected === p ? "border-2 border-cyan-400 bg-cyan-900/30 scale-105 animate-pulse text-cyan-100" : "border border-cyan-700/20 text-cyan-300"}
