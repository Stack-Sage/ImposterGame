  ...
  return (
    <div className="flex flex-col gap-10 mt-10 w-full">
      {answers.map((ans, i) => (
        <div
          key={i}
          className="glass p-8 rounded-2xl flex flex-row items-center justify-between hover:shadow-lg transition-all text-2xl border-2 border-cyan-700/20 bg-gradient-to-r from-sky-900/40 via-cyan-900/40 to-blue-900/40"
        >
