    ...
    <html lang="en">
      ...
      <body className="bg-[#0a1120] text-white text-2xl">
        <main className="min-h-screen flex flex-col items-center justify-start gap-4 p-2 sm:p-4">
          ...
          <section className="w-screen md:max-w-2xl lg:max-w-3xl mx-1 sm:mx-auto px-2 sm:px-6 py-4 sm:py-6 rounded-xl bg-gradient-to-br from-sky-900/10 via-cyan-900/10 to-blue-900/10 shadow transition hover:shadow-lg active:scale-95">
            {children}
          </section>
        </main>
      </body>
